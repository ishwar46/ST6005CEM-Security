...
const GalleryConfirmationModel = ({ isOpen, onCancel, onConfirm }) => {
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              ...
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500">Are you sure you want to delete this image?</p>
                </div>
              </div>
            </div>
          </div>
...
export default GalleryConfirmationModel;
